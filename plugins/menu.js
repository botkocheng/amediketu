...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    orderTitle: `Jangan diisi, karna ga ngaruh`,
...
"headerType": "DOCUMENT", "documentMessage": {
  ...
  }}, 'buttonsMessage', { quoted: m, contextInfo: { mentionedJid: conn.parseMention(text), forwardingScore: 999, isForwarded: true, externalAdReply: { title: 'Judul Yutup', body: `Deskripsi yutub`, description: 'Deskripsi yutub', mediaType: 2, thumbnail: thumb, mediaUrl: `https://youtube.com/watch?v=uIedYGN3NQQ`}}})
  
  logo2 = global.logo
  thumb = fs.readFileSync('./src/thumb.jpg')
